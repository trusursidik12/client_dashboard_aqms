...
<script>
    $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success == true) {
                            $('#list-aqm-param').load('<?= base_url('param-ispu-list/' . $station->station_id) ?>', function() {
                                $('#list_param_id').val('')
                            })
                        } else {
        ...
        $("#remove_param").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('/param-ispu-remove') ?>',
                data: {
                    'remove_param': true,
                    'deleteid': deleteid
                },
                ...
                success: function(result) {
                    if (result.success == true) {
                        ...
                        alert('gagal hapus parameter ispu')
                    }
                }
            })
        })
